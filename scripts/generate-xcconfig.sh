...
KAKAO_GROUP_INVITE_TEMPLATE_ID = ${KAKAO_GROUP_INVITE_TEMPLATE_ID_DEV:-0}
KAKAO_PROMISE_SHARE_TEMPLATE_ID = ${KAKAO_PROMISE_SHARE_TEMPLATE_ID_DEV:-0}
...
KAKAO_GROUP_INVITE_TEMPLATE_ID = ${KAKAO_GROUP_INVITE_TEMPLATE_ID_STAGE:-0}
KAKAO_PROMISE_SHARE_TEMPLATE_ID = ${KAKAO_PROMISE_SHARE_TEMPLATE_ID_STAGE:-0}
CLARITY_PROJECT_ID = ${CLARITY_PROJECT_ID}
...
KAKAO_GROUP_INVITE_TEMPLATE_ID = ${KAKAO_GROUP_INVITE_TEMPLATE_ID_PROD:-0}
KAKAO_PROMISE_SHARE_TEMPLATE_ID = ${KAKAO_PROMISE_SHARE_TEMPLATE_ID_PROD:-0}
CLARITY_PROJECT_ID = ${CLARITY_PROJECT_ID}
