...
extension SubscriptionClient: TestDependencyKey {
  ...
  public static let previewValue = Self(
    fetchProducts: {
      ...
      return [
        SubscriptionProduct(id: "com.promiso.pro.monthly", type: .monthly, displayName: "월간 프로", description: "매월 자동 갱신", displayPrice: "₩3,900", price: 3900),
        SubscriptionProduct(id: "com.promiso.pro.yearly", type: .yearly, displayName: "연간 프로", description: "매년 자동 갱신 (월 ₩3,250)", displayPrice: "₩39,000", price: 39000),
        SubscriptionProduct(id: "com.promiso.pro.lifetime", type: .lifetime, displayName: "평생 프로", description: "한 번 결제, 영구 사용", displayPrice: "₩59,000", price: 59000)
      ]
    },
    purchase: { _ in
