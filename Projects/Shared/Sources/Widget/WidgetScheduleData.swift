...
/// Widget에서 사용하는 통합 일정 모델 (그룹 일정 + 개인 일정)
public struct WidgetScheduleData: Codable, Identifiable, Equatable, Sendable {
  // MARK: - Constants
  ...
  /// 위젯 갤러리용 플레이스홀더 데이터
  public static var placeholder: WidgetScheduleData {
    WidgetScheduleData(
      type: .schedule,
      id: "placeholder",
      title: "점심 일정",
  ...
  /// 오늘 일정 샘플들
  public static var previewTodaySchedules: [WidgetScheduleData] {
  ...
  /// 다가오는 일정 샘플들
  public static var previewUpcomingSchedules: [WidgetScheduleData] {
    let calendar = Calendar.current
    let now = Date()
  ...
  /// 전체 프리뷰 샘플 (오늘 + 다가오는)
  public static var previewAllSchedules: [WidgetScheduleData] {
    previewTodaySchedules + previewUpcomingSchedules
  }

  // MARK: - Personal Event Preview Samples

  /// 오늘 개인 일정 샘플
  public static var previewTodayPersonalEvents: [WidgetScheduleData] {
    let calendar = Calendar.current
    let now = Date()
  ...
  /// 다가오는 개인 일정 샘플
  public static var previewUpcomingPersonalEvents: [WidgetScheduleData] {
    let calendar = Calendar.current
    let now = Date()
  ...
  /// 전체 개인 일정 프리뷰 샘플
  public static var previewAllPersonalEvents: [WidgetScheduleData] {
