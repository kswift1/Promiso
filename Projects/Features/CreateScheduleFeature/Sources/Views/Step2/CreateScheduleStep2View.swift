...
struct CreateScheduleStep2View: View {
...
struct LocationSection: View {
  ...
  var body: some View {
    SectionPlaceHolder(
      placeHolderTitle: LocalizedStrings.CreateSchedule.locationSection,
            ...
            if let location = store.schedule.location {
              ...
              Button {
                ...
                HStack(spacing: 12) {
                  ...
                  Text(LocalizedStrings.CreateSchedule.searchLocation)
                    .font(.system(size: 16))
