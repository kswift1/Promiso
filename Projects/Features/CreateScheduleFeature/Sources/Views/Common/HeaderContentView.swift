...
extension CreateScheduleStep {
    ...
    private var title: String {
        switch self {
        case .first: LocalizedStrings.CreateSchedule.step1Title
        case .second: LocalizedStrings.CreateSchedule.step2Title
        case .third: LocalizedStrings.CreateSchedule.step3Title
        }
    }

    private var subtitle: String {
        switch self {
        case .first: LocalizedStrings.CreateSchedule.step1Subtitle
        case .second: LocalizedStrings.CreateSchedule.step2Subtitle
        case .third: LocalizedStrings.CreateSchedule.step3Subtitle
        }
    }
}
...
#Preview("Step 2 헤더") {
    CreateScheduleStep.second.headerView
        .padding()
}
...
#Preview("컨텍스트 내에서") {
    VStack(alignment: .leading, spacing: 24) {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            TextField("일정 제목을 입력하세요", text: .constant(""))
                .padding()
...
#Preview("애니메이션 테스트") {
    struct AnimationTestView: View {
        ...
        var body: some View {
            VStack(spacing: 24) {
                [CreateScheduleStep.first, .second, .third][currentStep].headerView
