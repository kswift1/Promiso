...
public struct ScheduleDetailSectionHeader: View {
...
public struct ScheduleDetailExpandableText: View {
...
public struct ScheduleDetailEmojiInfoRow: View {
...
public struct ScheduleDetailLocationInfoRow: View {
...
public struct ScheduleDetailParticipantGroupRow: View {
  private let title: String
...
public struct ScheduleDetailLocationMapPreview: View {
...
public struct ScheduleDetailStatusBadgeView: View {
  private let status: ScheduleResponseStatus

  public init(status: ScheduleResponseStatus) {
    self.status = status
  }
...
public struct ScheduleDetailMemberListSheet: View {
  private let title: String
  private let members: [UserPublicModel]
  private let color: Color
      ...
      ScrollView {
        LazyVStack(spacing: 0) {
          ForEach(members) { member in
            ScheduleDetailMemberRow(member: member, color: color) {
...
public struct ScheduleDetailMemberRow: View {
