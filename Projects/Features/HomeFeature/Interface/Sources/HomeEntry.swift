// MARK: - HomeEntry.swift
// Home Feature의 Interface layer - TMA (Tuist Modular Architecture) 패턴을 따름
...
/// Home Feature integration을 위한 Entry Point
/// 상위 애플리케이션에 Home Feature를 임베딩하기 위한 깔끔한 interface 제공
/// 
/// 사용법:
/// ```swift
...
/// Home Feature 동작을 커스터마이징하기 위한 Configuration 객체
...
/// Home Feature navigation을 위한 Route 정의
/// Feature 내에서 deep linking과 programmatic navigation에 사용
public enum HomeRoute: Hashable, CaseIterable {
...
/// Home Feature에 특화된 Domain model과 data structure
/// Feature의 핵심 책임에 집중하여 가볍게 유지
extension HomeEntry {
  // Feature별 domain model을 여기에 추가
  // 예시:
  // public struct HomeItem: Equatable, Identifiable {
  //   public let id: UUID
