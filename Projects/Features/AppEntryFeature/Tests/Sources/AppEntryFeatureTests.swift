...
// TCA TestStore를 사용한 AppEntry Feature의 포괄적인 test suite
...
/// AppEntry Feature reducer와 business logic을 위한 Test suite
/// 예측 가능한 state testing과 side effect 검증을 위해 TCA의 TestStore를 사용
@MainActor
final class AppEntryFeatureTests: XCTestCase {
...
@MainActor
final class AppEntryFeatureIntegrationTests: XCTestCase {
