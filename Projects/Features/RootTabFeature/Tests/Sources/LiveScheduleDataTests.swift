//
//  LiveScheduleDataTests.swift
//  RootTabFeature
//
//  LiveSchedule 공유 데이터 모델 테스트
//
//  ## 테스트 대상
//  - `RootTabFeature/Sources/LiveSchedule/LiveScheduleFeature.swift`
//  - `LiveSchedule.Data` 구조체 (Feature와 Detail이 @Shared로 공유)
//
//  ## 사용처
//  - **LiveScheduleCompactView**: 하단 고정 바에서 도착/이동중 카운트 표시
//  - **LiveScheduleExpandedView**: 상세 화면에서 참가자 상태 요약
...
@Suite("LiveSchedule.Data 계산 테스트")
struct LiveScheduleDataTests {
  ...
  func arrivedCount_countsParticipantsWithETA0() {
    let data = LiveSchedule.Data(participants: [
