...
| N11-a | 실시간 공유 넛지 (대기중) | 대상: ETA == nil (미출발), 제목: "⏰ {약속명} X분 전!", 본문: "아직 안 나왔죠? 친구들이 보고 있어요 👀\n잠금화면 또는 앱에서 실시간 도착 예정시간을 공유해주세요!" |
| N11-b | 실시간 공유 넛지 (이동중) | 대상: ETA > 0 (이동중), 제목: "🏃 {약속명}까지 X분!", 본문: "잘 오고 계신가요? 👋\n잠금화면 또는 앱에서 실시간 도착 예정시간을 공유해주세요!" |
| N11-c | 실시간 공유 넛지 제외 대상 | ETA == 0 (도착) → 발송 안함 |
| N11-d | 실시간 공유 넛지 발송 횟수 | 1회만 |
| N11-e | 실시간 공유 넛지 별도 설정 | 없음 (항상 발송, 알림 설정에서 on/off 불가) |
