...
| ID | 구현 | 테스트 | 상태 |
|----|------|--------|:----:|
| N1 | `GroupNotificationPreferences.swift` `GroupNotificationSettings` (8종) | — | ❌ |
| N2 | `GroupNotificationPreferences.swift` 기본값 `enabled: true` | — | ❌ |
| N3~N10 | — (Backend only) | — | — |
...
|----|------|--------|:----:|
| B1 | — (Backend only) | — | — |
| B2 | `GroupClient.swift` `clearGroupBadge` | Mock 구현 | ⚠️ |
| B3 | — (Backend Firestore Rules) | — | — |

### 표시 규칙

| ID | 구현 | 테스트 | 상태 |
|----|------|--------|:----:|
| N11 | `NotificationModel.swift` `DeeplinkType` enum + `deeplink()` | `NotificationModelTests` 7개 | ✅ |
| N12 | `NotificationModel.swift` `NotificationFilter` enum (all, unread) | — | ❌ |

### 핵심 파일

| 구현 파일 | 경로 | 관련 규칙 |
|----------|------|----------|
| NotificationModel.swift | `Clients/Sources/Domain/Models/` | N11,N12 |
| GroupNotificationPreferences.swift | `Shared/Sources/Models/` | N1,N2 |
| NotificationClient.swift | `Clients/Sources/Clients/` | 전체 |
| GroupClient.swift | `Clients/Sources/Clients/` | B2 |
| NotificationSettingsFeature.swift | `Features/SettingsFeature/Sources/NotificationSettings/` | N1,N2 |
| NotificationCenterFeature.swift | `Features/NotificationCenterFeature/Sources/` | N11,N12 |

| 테스트 파일 | 경로 | 테스트 수 |
|------------|------|:--------:|
| NotificationModelTests.swift | `Clients/Tests/` | 7개+ |
